...
func TestMain(m *testing.M) {
	defaultConn := "host=localhost port=5432 user=furab password=furab_secret dbname=postgres sslmode=disable"
	...
	if connStr == "" {
		connStr = "host=localhost port=5432 user=furab password=furab_secret dbname=audit_log_service sslmode=disable"
	}
