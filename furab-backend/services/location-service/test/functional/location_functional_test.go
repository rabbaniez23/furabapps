...
// TestFunctional_Location_CreateAndGet tests basic CRUD with real database.
func TestFunctional_Location_CreateAndGet(t *testing.T) {
	// TODO: Setup test database connection
	// TODO: Create entity and verify retrieval
	t.Skip("TODO: Implement with real database")
}

// TestFunctional_Location_FullFlow tests the complete lifecycle.
func TestFunctional_Location_FullFlow(t *testing.T) {
